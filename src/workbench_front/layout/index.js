		...
		return (
			<div className='nc-workbench-layout'>
				<div className='nc-workbench-top-container  nccwb-header' style={{ zIndex: '1' }}>
					<nav field='top-area' fieldname={nodeName} className='nc-workbench-nav'>
						...
						<div className='nav-right n-right n-v-middle'>
							...
							>
								{sprType ? (
									<Icon title='开始录制SPR' type='play-circle-o' className='iconfont' />
								) : (
									<Icon title='结束录制SPR' type='pause-circle-o' className='iconfont' />
								)}
							</span>
							{this.getSearchDom()}
							<span
