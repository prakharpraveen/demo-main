...
import {
    ...
    setPageTemplateData,
    setParentData
} from "Store/AppRegister_bak/action";
...
export default connect(
    state => ({
        optype: state.AppRegister_bakData.optype,
        billStatus: state.AppRegister_bakData.billStatus,
        parentData: state.AppRegister_bakData.parentData,
        nodeData: state.AppRegister_bakData.nodeData,
        getFromData: state.AppRegister_bakData.getFromData,
        addTreeData: state.AppRegister_bakData.addTreeData,
        delTreeData: state.AppRegister_bakData.delTreeData,
        updateTreeData: state.AppRegister_bakData.updateTreeData,
        reqTreeData: state.AppRegister_bakData.reqTreeData,
        pageParentCode:state.AppRegister_bakData.pageParentCode
    }),
    {
        setNodeData,
        setBillStatus,
