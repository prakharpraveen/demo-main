...
import {setPageButtonData, setPageTemplateData,setNodeData} from "Store/AppRegister_bak/action";
...
class PageTable extends Component {
    ...
    handleOk = e => {
        ...
        Ajax({
            ...
            data: {
                pageid: this.props.nodeData.pk_apppage,
                code: templateCode,
                pagecode: this.props.nodeData.pagecode
            },
            success: ({data: {success, data}}) => {
                if (success && data) {
                    ...
                    this.setState({
                        ...
                        this.updatePageData(this.props.nodeData.pk_apppage);
                    });
                } else {
                    ...
                    <TabPane tab="页面模板注册" key="2">
                        ...
                        <Modal
                            ...
                            <div className="template-item">
                                ...
                                <span>{this.props.nodeData.pagecode}</span>
                            </div>
                            <div className="template-item">
                                <label htmlFor="">页面主键：</label>
                                <span>{this.props.nodeData.pk_apppage}</span>
                            </div>
                        </Modal>
                    </TabPane>
                </Tabs>
...
export default connect(
    state => {
        return {
            ...
            pageTemplets: state.AppRegister_bakData.pageTemplets,
            appButtonVOs: state.AppRegister_bakData.appButtonVOs,
            nodeData: state.AppRegister_bakData.nodeData
        };
    },
    {setPageButtonData, setPageTemplateData,setNodeData}
